...
public class ReservationController {
    ...
    @ApiResponses({
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "이메일 또는 전화번호 형식이 올바르지 않음")
    })
    public ResponseEntity<ApiResponse<List<ReservationSearchResponse>>> searchReservations(
        ...
        return ResponseEntity.ok(ApiResponse.success(reservationService.searchReservations(guestEmail, guestPhone)));
    }
    ...
    @ApiResponses({
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "입력값 또는 예약 정책 위반"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "운영 중인 스터디룸을 찾을 수 없음"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "409", description = "이미 예약된 시간대")
    })
    ...
    @ApiResponses({
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "입력값이 올바르지 않거나 예약자 정보가 일치하지 않음"),
